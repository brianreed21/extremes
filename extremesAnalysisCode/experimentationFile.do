...
keep if ((indgroup!="services") & (indgroup!="finance") & (indgroup!="") & (totalcostnormd != .))

local replace replace
foreach weather of varlist excessrainemp excessheat90plusemp{
	foreach outcome of varlist salesnormd totalcostnormd lnsalesnormd_take2 lntotalcostnormd_take2   {
